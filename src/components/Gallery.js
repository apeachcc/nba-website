            ...
            <div className="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div className="col">
                    <div className="card">
                        ...
                        />
                        <div className="card-body">
                            <h5 className="card-title">2022-2023 City Edition Uniforms</h5>
                            <p className="card-text">
                                Learn more about the city edition uniform and shop the collection on the website.
                            </p>
                ...
                <div className="col">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">
                                New this year, you can create your own stackable partial plan from eight unique five-game options. 
                            </p>
